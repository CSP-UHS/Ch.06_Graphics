...
'''
import arcade;starsx=8.19;starsy=14.04;stars=0;row=6;arcade.open_window(494,260,"The Stars and Stripes");
arcade.set_background_color(arcade.color.WHITE);arcade.start_render()
for y_offset in range(0,494,40):
    arcade.draw_rectangle_filled(247,10+y_offset,494,20,(191,10,48))
arcade.draw_rectangle_filled(98.8,190,197.6,140,(00,28,68))
