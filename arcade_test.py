...
arcade.open_window(600, 600, "That one thing")
arcade.set_background_color((255, 255, 255))
arcade.start_render()
arcade.draw_circle_filled(300, 200, 100, (255, 0, 0, 255))
arcade.draw_circle_filled(250, 275, 100, (0, 255, 0, 255))
arcade.draw_circle_filled(350, 275, 100, (0, 0, 255, 255))

arcade.draw_circle_filled(300, 200, 100, (255, 0, 0, 100))

arcade.draw_circle_filled(250, 275, 100, (0, 255, 0, 100))

arcade.draw_circle_filled(350, 275, 100, (0, 0, 255, 100))

arcade.draw_texture_rectangle(300, 300, 300, 300)
for xoffset in range(0, 620, 30):
    arcade.draw_rectangle_filled(0 + xoffset, 20, 10, 30, (0, 0, 0))
